...
--userId: 5
INSERT INTO users (username, email, password, first_name, last_name) VALUES ('Dr.Chavez', 'user5@test.com', '$2b$10$uu8xM9X2soPuBr0ArpI9FOOly9NaN1xPhv2tYoAj.6Il4UaMpAi3W', 'test', 'user');
--userId: 6
INSERT INTO users (username, email, password, first_name, last_name) VALUES ('Dr.Stuart', 'user6@test.com', '$2b$10$uu8xM9X2soPuBr0ArpI9FOOly9NaN1xPhv2tYoAj.6Il4UaMpAi3W', 'test', 'user');
--userId: 7
...
-- sample doctor --tbd
INSERT INTO users (username, email, password, first_name, last_name) VALUES ('test11', 'test11@test.com11', '$2b$10$uu8xM9X2soPuBr0ArpI9FOOly9NaN1xPhv2tYoAj.6Il4UaMpAi3W', 'test', 'user');
...
INSERT INTO posts (title, content, category, is_anonymous, user_id, username) VALUES ('I hear a ringing in my ear, is that bad?', '', 'Medical', true, 1, 'TheMainMan');
-- INSERT INTO posts (title, content, category, is_anonymous, user_id, username) VALUES ('Hello, Everyone', 'Hello, this is my first time here. I am happy to be on the platform and excited to get to meet all of you!', 'General', false, 1, 'TheMainMan') RETURNING *
-- INSERT INTO posts (title, content, category, is_anonymous, user_id, username) VALUES ('Hello, Everyone', 'Hello, this is my first time here. I am happy to be on the platform and excited to get to meet all of you!', 'General', false, 1, 'TheMainMan') RETURNING *
-- INSERT INTO posts (title, content, category, is_anonymous, user_id, username) VALUES ('Hello, Everyone', 'Hello, this is my first time here. I am happy to be on the platform and excited to get to meet all of you!', 'General', false, 1, 'TheMainMan') RETURNING *
